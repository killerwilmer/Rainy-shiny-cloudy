...
class WeatherVC: UIViewController, UITableViewDelegate, UITableViewDataSource, CLLocationManagerDelegate {
    ...
    override func viewDidLoad() {
        ...
        locationManager.requestWhenInUseAuthorization() // Only use when user open app
        locationManager.startMonitoringSignificantLocationChanges() // When phone chage location
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if let cell = tableView.dequeueReusableCell(withIdentifier: "weatherCell", for: indexPath) as? WeatherCell {
            ...
            cell.configureCel(forecast: forecast)
            return cell
        } else {
            return WeatherCell()
        }
    }
    // End funcs for the tables
